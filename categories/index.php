            ...
            <div class="col-lg-8 col-md-10 col-sm-12 col-sm-12 mb-3">
                <div class="input-group input-group-lg" id="search-field">
                    ...
                    <div class="input-group-append">
                        <span class="input-group-text rounded-pill" style="background-color: #2e313b; color: white;"><i class="fa fa-search"></i></span>
                    </div>
                </div>
            </div>
        </div>
        <div class="accordion" id="categoryAccordion">
            ...
            <div class="card mb-0 rounded-0">
                <div class="card-header" id="category<?= $row['id'] ?>">
                    <h2 class="mb-0">
                        <button class="btn btn-block text-left font-weight-bolder text-white" type="button" data-toggle="collapse" data-target="#collapse<?= $row['id'] ?>" aria-expanded="false" aria-controls="collapse<?= $row['id'] ?>">
